...
def evaluate_performance(model,
    ...
    if model_type == 'UNET' or model_type == 'RNET' or model_type == 'RFI_NET':
        ...
        for i in range(10):
            ...
            axs[i, 0].imshow(test_data_recon[r, ..., 0].astype(np.float32), interpolation='nearest',
                             aspect='auto')
            axs[i, 1].imshow(test_masks_recon[r, ..., 0].astype(np.float32),
                             interpolation='nearest', aspect='auto')
            axs[i, 2].imshow(x_hat_recon[r, ..., 0].astype(np.float32), interpolation='nearest',
                             aspect='auto')
        ...
        for i in range(10):
            ...
            axs[i, 1].imshow(test_masks_recon[r, ..., 0].astype(np.float32),
                             interpolation='nearest', aspect='auto')
            axs[i, 2].imshow(dists_recon[r, ..., 0].astype(np.float32), interpolation='nearest',
                             aspect='auto')
        plt.savefig('outputs/{}/{}/{}/neighbours.png'.format(model_type,
                                                             args.anomaly_class,
                                                             args.model_name), dpi=300)
    ...
    for i in range(10):
        r = np.random.randint(len(test_data_recon))
        axs[i, 0].imshow(test_data_recon[r, ..., 0].astype(np.float32), vmin=0, vmax=1,
                         interpolation='nearest', aspect='auto')
        axs[i, 1].imshow(test_masks_recon[r, ..., 0].astype(np.float32), vmin=0, vmax=1,
                         interpolation='nearest', aspect='auto')
        axs[i, 2].imshow(error_recon[r, ..., 0].astype(np.float32), vmin=0, vmax=1,
                         interpolation='nearest', aspect='auto')
        axs[i, 3].imshow(nln_error_recon[r, ..., 0].astype(np.float32), vmin=0, vmax=1,
                         interpolation='nearest', aspect='auto')
        axs[i, 4].imshow(dists_recon[r, ..., 0].astype(np.float32), interpolation='nearest',
                         aspect='auto')
        axs[i, 5].imshow(combined_recon[r, ..., 0].astype(np.float32), vmin=0, vmax=1,
                         interpolation='nearest', aspect='auto')
        axs[i, 6].imshow(x_hat_recon[r, ..., 0].astype(np.float32), vmin=0, vmax=1,
                         interpolation='nearest', aspect='auto')
