...
unet_mean, rfinet_mean, rnet_mean = [0.8017, 0.7462, 0.6949], [0.8109, 0.7638, 0.7650], [0.8262,
                                                                                         0.7842,
                                                                                         0.6791]
unet_std, rfinet_std, rnet_std = [0.0058, 0.0421, 0.1303], [0.0037, 0.0028, 0.0036], [0.0072,
                                                                                      0.0422,
                                                                                      0.1551]
...
ax.grid()
ax.legend(handles=[rects1, rects2, rects3, rects4], labels=['NLN', 'UNET', 'RFI-Net', 'RNET'],
          loc='lower right')
