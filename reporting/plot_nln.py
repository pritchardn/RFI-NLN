...
ae = Autoencoder(args)
ae.load_weights(
    'outputs/DAE_disc/rfi/fuzzy-charming-skink-of-rain/training_checkpoints/checkpoint_full_model_ae')
...
neighbours_dist, neighbours_idx, x_hat_train, neighbour_mask = nln(z, z_query, x_hat_train, 'knn',
                                                                   20, -1)
nln_error = get_nln_errors([ae], 'AE', z_query, z, test_data, x_hat_train, neighbours_idx,
                           neighbour_mask, args)
...
axs.imshow(make_grid(test_data_recon[ind, ..., 0].T), vmin=0, vmax=_max, interpolation='nearest',
           aspect='auto')
...
fig, axs = plt.subplots(figsize=(5, 5))
axs.imshow(make_grid(neighbour_0_recon[ind, ..., 0].T), vmin=0, vmax=_max, interpolation='nearest',
           aspect='auto')
axs.set_xlabel('Time [s]', fontsize=fs)
axs.set_ylabel('Cropped Frequency Bins', fontsize=fs)
plt.tight_layout()
...
fig, axs = plt.subplots(figsize=(5, 5))
axs.imshow(make_grid(neighbour_10_recon[ind, ..., 0].T), vmin=0, vmax=_max, interpolation='nearest',
           aspect='auto')
axs.set_xlabel('Time [s]', fontsize=fs)
axs.set_ylabel('Cropped Frequency Bins', fontsize=fs)
plt.tight_layout()
...
fig, axs = plt.subplots(figsize=(5, 5))
axs.imshow(make_grid(neighbour_19_recon[ind, ..., 0].T), vmin=0, vmax=_max, interpolation='nearest',
           aspect='auto')
axs.set_xlabel('Time [s]', fontsize=fs)
axs.set_ylabel('Cropped Frequency Bins', fontsize=fs)
plt.tight_layout()
...
fig, axs = plt.subplots(figsize=(5, 5))
axs.imshow(make_grid(nln_error_recon[ind, ..., 0].T), vmin=0, vmax=_max, interpolation='nearest',
           aspect='auto')
axs.set_xlabel('Time [s]', fontsize=fs)
axs.set_ylabel('Cropped Frequency Bins', fontsize=fs)
plt.tight_layout()
...
fig, axs = plt.subplots(figsize=(5, 5))
axs.imshow(combined_recon[ind, ..., 0].T > t, vmin=0.0, vmax=_max, interpolation='nearest',
           aspect='auto')
axs.set_xlabel('Time [s]', fontsize=fs)
axs.set_ylabel('Cropped Frequency Bins', fontsize=fs)
plt.tight_layout()
